...
# -----data related-----
data_root = '/data/nl/mmdet2spectral/data/SMOD/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train_clear.json'
train_data_prefix = 'train/low/rgb'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'val_clear.json'
val_data_prefix = 'val/low/rgb'  # Prefix of val image path

num_classes = 4  # Number of classes for classification
classes = ('person', 'rider', 'bicycle','car')
metainfo = dict(classes=classes, palette=[(20, 220, 60),(119, 11, 32), (0, 0, 142),(0, 80, 100)])
...
optim_wrapper = dict(
    ...
    # optimizer=dict(_delete_=True,type='AdamW', lr=base_lr, weight_decay=0.0001),
