...
model = dict(
    ...
    backbone=dict(
        ...
        fusion_module = dict(type = 'CosineSortedMaxFusionModule' , epsilon=[1e-8 , 1e-8 , 1e-8]),
        head_input_module = dict(type = 'CosineSortedMaxFusionModule' , epsilon=[1e-8 , 1e-8 , 1e-8]),
    ),
    neck=dict(
        type='YOLOv8PAFPN',
        deepen_factor=_base_.deepen_factor,
