_base_ = '/data/nl/Mamba2Spectral/projects/yolo_dual/datasets/M3FD_low.py'
...
model = dict(
    ...
    backbone=dict(
        ...
        fusion_block=dict(type = 'BaseFusion',in_channels = [128,256,512],),
        fusion_module = dict(type = 'SHFModule',in_channels = [128,256,512],),
        head_input_module = dict(type = 'SHFModule',in_channels = [256,512,1024],),
    ),
    neck=dict(
        type='YOLOv8PAFPN',
        deepen_factor=_base_.deepen_factor,
