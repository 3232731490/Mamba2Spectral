# 定义配置文件和数据文件的数组
configs=(
  projects/yolo_dual/FLIR/2025_06_03/yolov8_mambatransformer_enhance.py
  projects/yolo_dual/FLIR/2025_06_03/yolov8_mambatransformer_enhance_lightfusion.py
)
