...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='val.json',
        batch_shapes_cfg=None,
        data_prefix=dict(img='val/enhance_true/rgb'),
        data_root='/data/nl/mmdet2spectral/data/DroneVehicle_partion/',
        metainfo=dict(
            classes=(
                'car',
...
train_cfg = dict(
    ...
    val_interval=1)
train_data_prefix = 'train/enhance_true/rgb'
train_dataloader = dict(
    batch_size=8,
    collate_fn=dict(type='dual_yolo_collate'),
    dataset=dict(
        ann_file='train.json',
        data_prefix=dict(img='train/enhance_true/rgb'),
        data_root='/data/nl/mmdet2spectral/data/DroneVehicle_partion/',
...
val_data_prefix = 'val/enhance_true/rgb'
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='val.json',
...
weight_decay = 0.0005
widen_factor = 0.75
work_dir = 'work_dirs/DroneVehicle/2025_06_30/yolov8_mambatransformer_enhance'
