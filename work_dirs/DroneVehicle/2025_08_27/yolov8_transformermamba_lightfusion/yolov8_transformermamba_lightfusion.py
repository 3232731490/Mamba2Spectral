...
data_root = '/data/nl/mmdet2spectral/data/DroneVehicle_partion/'
...
test_evaluator = dict(
    ann_file='/data/nl/mmdet2spectral/data/DroneVehicle_partion/val.json',
    classwise=True,
    metric='bbox',
    proposal_nums=(
        100,
...
weight_decay = 0.0005
widen_factor = 0.75
work_dir = 'work_dirs/DroneVehicle/2025_08_27/yolov8_transformermamba_lightfusion'
