...
data_root = '/data/nl/mmdet2spectral/data/SMOD/'
    ...
    backbone=dict(
        ...
        head_input_module=dict(
            in_channels=[
                ...
                512,
                1024,
            ], type='DetectionHeadFusionModule'),
        input_channels=3,
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='val_clear.json',
        batch_shapes_cfg=None,
        data_prefix=dict(img='val/low/rgb'),
        data_root='/data/nl/mmdet2spectral/data/SMOD/',
        metainfo=dict(
            classes=(
                'person',
...
test_evaluator = dict(
    ann_file='/data/nl/mmdet2spectral/data/SMOD/val_clear.json',
    classwise=True,
    metric='bbox',
    proposal_nums=(
        100,
...
train_ann_file = 'train_clear.json'
...
train_cfg = dict(
    ...
    val_interval=1)
train_data_prefix = 'train/low/rgb'
train_dataloader = dict(
    batch_size=8,
    collate_fn=dict(type='dual_yolo_collate'),
    dataset=dict(
        ann_file='train_clear.json',
        data_prefix=dict(img='train/low/rgb'),
        data_root='/data/nl/mmdet2spectral/data/SMOD/',
...
val_ann_file = 'val_clear.json'
val_batch_size_per_gpu = 1
val_cfg = dict(type='ValLoop')
val_data_prefix = 'val/low/rgb'
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='val_clear.json',
...
weight_decay = 0.0005
widen_factor = 0.75
work_dir = 'work_dirs/FLIR/2025_06_03/yolov8_mambatransformer_lightfusion'
