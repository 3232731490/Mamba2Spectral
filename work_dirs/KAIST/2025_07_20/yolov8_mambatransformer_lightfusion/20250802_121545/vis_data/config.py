...
data_root = '/data/nl/mmdet2spectral/data/KAIST/'
...
test_evaluator = dict(
    ann_file='/data/nl/mmdet2spectral/data/KAIST/val_class4.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
...
train_cfg = dict(
    ...
    val_interval=1)
train_data_prefix = 'train/rgb'
train_dataloader = dict(
    batch_size=8,
    collate_fn=dict(type='dual_yolo_collate'),
    dataset=dict(
        ann_file='train_class4.json',
...
weight_decay = 0.0005
widen_factor = 0.75
work_dir = 'work_dirs/KAIST/2025_07_20/yolov8_mambatransformer_lightfusion'
