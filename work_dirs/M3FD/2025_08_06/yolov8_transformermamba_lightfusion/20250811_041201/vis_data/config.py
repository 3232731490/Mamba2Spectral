...
data_root = '/data/nl/mmdet2spectral/data/M3FD/'
...
test_evaluator = dict(
    ann_file='/data/nl/mmdet2spectral/data/M3FD/val_partion.json',
    classwise=True,
    metric='bbox',
    proposal_nums=(
        100,
...
weight_decay = 0.0005
widen_factor = 0.75
work_dir = 'work_dirs/M3FD/2025_08_06/yolov8_transformermamba_lightfusion'
