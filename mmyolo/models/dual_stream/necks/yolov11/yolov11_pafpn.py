...
from mmyolo.models.necks.yolov5_pafpn import YOLOv5PAFPN,make_divisible, make_round
from mmyolo.models.dual_stream.backbones.backbone_pool.yolov11Backbone import C3k2


@MODELS.register_module()
class YOLOv11PAFPN(YOLOv5PAFPN):
