...
def build_yoloV11Stage(setting: list):
    """Build a stage layer.
    ...
    """
    in_channels, hiden_channels,out_channels, num_blocks, c3k, e,use_spp = setting.in_channels ,setting.hiden_channels, setting.out_channels , setting.num_blocks , setting.c3k , setting.e,setting.use_spp
    in_channels = make_divisible(in_channels, setting.widen_factor)
    out_channels = make_divisible(out_channels, setting.widen_factor)
    hiden_channels = make_divisible(hiden_channels, setting.widen_factor)
