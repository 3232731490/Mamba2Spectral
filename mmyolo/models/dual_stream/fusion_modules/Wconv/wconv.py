...
class WTConv(nn.Module):
    def __init__(self, in_channels, kernel_size=5,wt_levels=1, stride=1, bias=True,  wt_type='db1'):
        super(WTConv, self).__init__()
        self.wtconv = WTConv2d(in_channels * 2 ,in_channels * 2,kernel_size=kernel_size, wt_levels=wt_levels)
